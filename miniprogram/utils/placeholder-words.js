/* 占位词表 —— 顾客可见字段的「这不是数据」判别(店主 11j 判据 A,2026-09-22)
 *
 * ══ 为什么要这份表 ══
 ...
 *      词表来自 11j 判据 A 明列的七个词;第八个「待定」由 **11k §二.3 明确授权**加入。
      🔴 11k 同时写死:「暂无」「无」「空」「—」**没有授权**,不许一起加(J-107)。 */
const PLACEHOLDER_WORDS = ['TBD', 'placeholder', 'N/A', '待填', '待补充', '占位', '未填', '待定']
...
module.exports = { PLACEHOLDER_WORDS, isPlaceholderValue, realValue }
