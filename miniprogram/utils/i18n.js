...
const copy = {
  ...
  home: {
    ...
    en: {
      ...
      emptyServiceNote: 'The shop is still setting up its service menu.',
      storeTitle: 'Store',
      hours: 'Hours',
      phone: 'Phone',
      address: 'Address',
  ...
  checkout: {
    ...
    en: {
      ...
      balanceHint: 'Deposit follows the store policy and cannot be deducted',
