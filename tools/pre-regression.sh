...
# ⚠️ 2026-09-23 案底(CI 红一次才照出来):这条判据是对的,漏的是**跑它的时机**。
#    11o 那批把 local-server.mjs 从 17527 降到 17526,预检当时显示
#    「17526 ≤ 17527(上一提交 17527)」—— **合法通过**,因为那一刻「上一提交」还是 11p 的 17527。
#    提交之后「上一提交」变成 17526,而历史最低仍记着 17527 ⇒ 不一致,
