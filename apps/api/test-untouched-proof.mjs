...
/* ══ J-49 **第二款**(店主 07c 裁 #57 立,2026-09-12)══
 * 第一款(判据这一侧):**认标记不认措辞** —— 判据不许把「否认」当成「声称」。
 * 第二款(作者这一侧):**不许换一个同义词去躲开判据。**
 *   该作声称的时候就用**标准说法**(「〈库名〉未动」)+ 挂标记,不许用近义词绕过去。
 *
 * 由来是我自己:夜9 回执里我把安全保证写成「**未碰** / 逐表零差异」——
 * 意思一样,但这把刀按字面认「未动」,**换个说法它就看不见**,存量 34 一动不动。
 * 那不是判据宽,是**作者把声称写成了判据认不出的样子**。
 * 第一款防判据误判,第二款防作者绕道;**两款一起才闭合。**
 *
 * ⚠️ 这一款**故意不做成自动判据**:要机器去认「所有同义说法」,等于回到黑名单那一套
 *   (今天加「未碰」,明天有人写「没动过」)。它是**写给作者的规矩**,
 *   靠交付纪律与复核守;这段注释就是它的落点。
 */
