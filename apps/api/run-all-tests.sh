...
DEMO_GATE_SUITES="auth-surface booking-intake card-refund customer-profile deposit-config identity-links mini-ai-same-outlet noshow-aftersales schedule-v2 staff-portal stored-value wechat-stub mini-phone web-settlement cross-end-effect display-text tenant-ownership"
